...
const queryUrlMappings = {
	...
	funnels: {
		// Maybe these first two tests should just throw errors, because
		// keen's funnel API doesn't support avg(). Or anything other
		// than count_unique (which translates to 'actor_property')
		// See: https://keen.io/docs/api/#funnels
		'@funnel(tomato:bread->count(prop),hat:potato->avg(prop))': 'https://api.keen.io/3.0/projects/test_proj/queries/funnel?api_key=test_key&steps=%5B%7B%22event_collection%22%3A%22tomato%3Abread%22%2C%22target_property%22%3A%22prop%22%2C%22timeframe%22%3A%22this_14_days%22%2C%22actor_property%22%3A%22prop%22%7D%2C%7B%22event_collection%22%3A%22hat%3Apotato%22%2C%22target_property%22%3A%22prop%22%2C%22timeframe%22%3A%22this_14_days%22%2C%22actor_property%22%3A%22prop%22%7D%5D',
		'skip.@funnel(tomato:bread->count(prop),hat:potato->avg(prop))->with(prop2)': 'https://api.keen.io/3.0/projects/test_proj/queries/funnel?api_key=test_key&steps=%5B%7B%22event_collection%22%3A%22tomato%3Abread%22%2C%22target_property%22%3A%22prop%22%2C%22timeframe%22%3A%22this_14_days%22%2C%22actor_property%22%3A%22prop2%22%7D%2C%7B%22event_collection%22%3A%22hat%3Apotato%22%2C%22target_property%22%3A%22prop%22%2C%22timeframe%22%3A%22this_14_days%22%2C%22actor_property%22%3A%22prop2%22%7D%5D',
