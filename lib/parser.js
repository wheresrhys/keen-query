...
const reduceStrategies = Object.assign({all: true}, require('./post-processing').reduceStrategies);
...
function isPostProcessor(funcName) {
	return postProcessors.indexOf(funcName) > -1
}

module.exports = deconstruct;
module.exports.parseFilter = parseFilter;
module.exports.isPostProcessor = isPostProcessor;
