...
const methods = {
	...
	interval: function (interval) {
		...
		// Keen extractions are different to all other queries. They do not support grouping or intervals.
		if (this.extraction === "extraction") {
			console.log("Removing instance() from the query as it's not supported in keen extractions.");
			return instance;

			// Todo: Decide whether it's better to "magically fix" the query, or throw an error
	...
	group: function () {
		...
		// Keen extractions are different to all other queries. They do not support grouping or intervals.
		if (this.extraction === "extraction") {
			console.log("Removing group() from the query as it's not supported in keen extractions.");
