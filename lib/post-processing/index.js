...
function stringifyPostProcessors () {
...
module.exports.mixin = function (proto, transform) {
	postProcessorNames.forEach(method => {
		proto[method] = transform ? transform(postProcessors[method], method) : postProcessors[method];
		proto.stringifyPostProcessors = stringifyPostProcessors;
	});
