...
/**
	The code below is generally more comprehensible if each case is understood before trying to understand the next
	Each one handles a slightly more complex case than the previous and can be thought of as a hybrid
	of the two preceding approaches
**/
